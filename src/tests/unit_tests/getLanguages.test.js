...
describe("getLanguages", () => {
    it("Should be able to get languages", async () => {
        try{
            ...
            expect(languages).toStrictEqual(languageTest);
        }catch(error){
            console.error("Error in getLanguages[Nr. 1] ", error);
        }
    })
});
